...
class AppConfig:
    ...
    def _load_providers(cls, providers_env: str) -> Dict[str, ProviderConfig]:
        ...
        providers = {
            ...
            "777114_xyz": ProviderConfig(
                name="777114_xyz",
                origin="https://api.777114.xyz",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",
                ...
                github_client_id=None,
                github_auth_path=None,
                linuxdo_client_id="tEhiG5R74xdLkzzhZK9J72jfuJPC6rVL",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            "nlacloud_shop": ProviderConfig(
                name="nlacloud_shop",
                origin="https://www.nlacloud.shop",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",
                ...
                github_client_id=None,
                github_auth_path=None,
                linuxdo_client_id="1dQNhDtmjidaRmiJ0XWtpFiJIUlbS9sG",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            "lx_blogsummer_cn": ProviderConfig(
                name="lx_blogsummer_cn",
                origin="https://lx.blogsummer.cn",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",
                ...
                github_client_id=None,
                github_auth_path=None,
                linuxdo_client_id="TIycQsOKtnuaNtuzxZ5RDofCCeMpgdEe",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            "llmapi_vhuds_com": ProviderConfig(
                name="llmapi_vhuds_com",
                origin="https://llmapi.vhuds.com",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",
                ...
                github_client_id=None,
                github_auth_path=None,
                linuxdo_client_id="aiepRPewQgwTPbUIq8Z4muSYw76NFSUZ",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method="cf_clearance",
            ),
            "zapi_aicc0_com": ProviderConfig(
                name="zapi_aicc0_com",
                ...
                github_client_id=None,
                github_auth_path=None,
                linuxdo_client_id="Tm30iXRcGTM9oyVreW3edvCNGO5kPEWX",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method="cf_clearance",
            ),
            "anthorpic_us_ci": ProviderConfig(
                name="anthorpic_us_ci",
                origin="https://anthorpic.us.ci",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",  # 标准 newapi checkin 接口
                ...
                github_client_id=None,
                github_auth_path="/api/oauth/github",
                linuxdo_client_id="nNzrggkmAew2bJYxCgC2iaU6IYcaWt8S",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            "clove_cc": ProviderConfig(
                name="clove_cc",
            ...
            "freestyle_cc_cd": ProviderConfig(
                name="freestyle_cc_cd",
            ...
            "codex_cab": ProviderConfig(
                name="codex_cab",
                origin="https://codex.cab",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",  # 标准 newapi checkin 接口
                ...
                github_client_id=None,
                github_auth_path="/api/oauth/github",
                linuxdo_client_id="nYxyCYi7VDrfjNn2rBM8VkPaKNKxWEx1",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            "einzieg_site": ProviderConfig(
                name="einzieg_site",
            ...
            "free_nanohajimi_mom": ProviderConfig(
                name="free_nanohajimi_mom",
                origin="https://free.nanohajimi.mom",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",  # 标准 newapi checkin 接口
                ...
                github_client_id=None,
                github_auth_path="/api/oauth/github",
                linuxdo_client_id="svkUqtRyhOJMULQ1Zfnfhvv9ALSnANhf",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            "ibsgss_uk": ProviderConfig(
                name="ibsgss_uk",
                origin="https://codex.ibsgss.uk",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",  # 标准 newapi checkin 接口
                ...
                github_client_id=None,
                github_auth_path="/api/oauth/github",
                linuxdo_client_id="F3kKRQ29SJGivfhtIpjE0W0tAyxbvR2X",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            "npcodex_kiroxubei_tech": ProviderConfig(
                name="npcodex_kiroxubei_tech",
            ...
            "aicenter_hejiu_icu": ProviderConfig(
                name="aicenter_hejiu_icu",
                origin="https://aicenter.hejiu.icu",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",  # 标准 newapi checkin 接口
                ...
                github_client_id=None,
                github_auth_path="/api/oauth/github",
                linuxdo_client_id="7MtktQtr4PIZz9y6LEcw7q3k7kDKKH1k",
                linuxdo_auth_path="/api/oauth/linuxdo",
                aliyun_captcha=False,
                bypass_method=None,
            ),
            "newapi_sorai_me": ProviderConfig(
                name="newapi_sorai_me",
